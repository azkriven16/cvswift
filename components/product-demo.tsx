...
const stages = [
  ...
  },
  {
    label: "AI Rewrite",
    icon: GitBranch,
    title: "AI rewrites included",
    detail: "Rewrite bullets, sharpen tone, and tailor for any role — all free, no account upgrade needed.",
    velocity: "94%",
    risk: "86",
    agents: "Free",
    cards: [
      { id: "AI-21", title: "Improved onboarding conversion 18% by rebuilding React flow", tag: "Rewrite", state: "Done" },
      { id: "JOB-08", title: "Tailored against Senior Frontend Engineer at Vercel", tag: "JD", state: "Ready" },
      { id: "CVR-03", title: "Cover letter generated for Senior Frontend role", tag: "Cover", state: "New" },
    ],
    terminal: ["rewrote 3 experience bullets", "tailored to job description", "cover letter generated"],
  },
  {
    label: "Export",
    icon: Rocket,
    title: "Resume ready to export",
    detail: "Download a clean ATS-ready PDF or share a public resume link — no login required to view.",
    velocity: "97%",
    risk: "91",
    agents: "5/5",
    cards: [
      { id: "PDF-10", title: "Export clean ATS-readable PDF", tag: "PDF", state: "Ready" },
      { id: "LNK-05", title: "Share public resume link — no login required to view", tag: "Link", state: "Live" },
      { id: "TMP-12", title: "Switch template: ATS Clean, Harvard, Executive, Sidebar", tag: "Template", state: "4 options" },
    ],
    terminal: ["rendered ATS-ready PDF", "public link activated", "all templates available"],
  },
];
